...
int main()
{
	...
	Dados_M = Model();
	Dados_M.LoadModel("Models/Phineas/dados.obj");
	Puesto_dados = Model();
...
//---------------Phineas---------
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f + mainWindow.getmuevex(), -0.8f, -3.0f));
		...
		//---------------Banca---------
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-10.0f, -0.9f, 30.0f));
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.23));
		...
		//---------------Laboratorio---------
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-34.0f, -1.0f, 62.901f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));
		model = glm::rotate(model, -180 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-35.7f, -1.0f, 60.0f));
		...
		//---------------Inator---------
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-34.2f, 11.5f, 60.0f));
		...
		//---------------Puesto de peluches---------
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-34.0f, -1.0f, 15.0f));
		...
		//---------------Puesto de Limonada---------
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-72.0f, -1.0f, 30.0f));
		...
		//---------------Mesa de Hamburguesa---------
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-65.0f, -1.0f, 45.0f));
		...
		//---------------Mesa de Hamburguesa---------
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-55.0f, -1.0f, 45.0f));
		...
		//---------------Mesa de Hamburguesa---------
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-46.0f, -1.0f, 60.0f));
		...
		//---------------Mesa de Hamburguesa---------
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-46.0f, -1.0f, 50.0f));
		...
		//---------------Aatraccion de Dados---------
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-60.0f, -1.0f, 15.0f));
